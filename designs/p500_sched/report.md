...
| AQ-C12 | inducer incidence range along the running line (max - min) | 13.46 deg | 0 .. 10 | 0.65 | a wide incidence swing means the inlet metal angle cannot suit both idle and max power |
| AQ-C13 | vaned-diffuser incidence at the lowest converged speed | -9.44 deg | -6 .. 5 | 0.69 | large positive incidence at low speed = diffuser stall = low-speed surge |
...
Combustion efficiency 0.985, LBO margin design 2.402 / idle 1.332, pattern factor 0.27 (NGV peak 1336 K), liner wall 978 K, altitude relight index 1.103. pattern factor, blow-out and wall temperature: +/-30 % model-form uncertainty (Lefebvre correlations)
...
Running line at the design condition: idle at N 0.4 (21.8 N), minimum surge margin 0.0687 at N 1.1, max point 493.6 N at T04 1150 K (T04-limited).

| N/N_d | thrust N | TSFC | T04 K | EGT K | SM | PR_c |
|---|---|---|---|---|---|---|
| 0.40 | 22 | 0.497 | 864 | 838 | +0.300 | 1.22 |
| 0.45 | 29 | 0.427 | 867 | 833 | +0.366 | 1.29 |
| 0.50 | 37 | 0.351 | 819 | 779 | +0.412 | 1.36 |
| 0.55 | 51 | 0.286 | 803 | 755 | +0.415 | 1.48 |
| 0.60 | 65 | 0.233 | 774 | 719 | +0.433 | 1.59 |
| 0.65 | 88 | 0.193 | 771 | 704 | +0.453 | 1.76 |
| 0.70 | 113 | 0.161 | 762 | 687 | +0.390 | 1.95 |
| 0.75 | 151 | 0.142 | 791 | 703 | +0.321 | 2.20 |
| 0.80 | 197 | 0.131 | 838 | 738 | +0.237 | 2.48 |
...
Envelope: 68/96 grid points cleared (SM >= floor), worst SM -0.04617 at 9000.0 m / M 0.6 / dT -20.0 K; SLS max thrust 493.6 N.
...
* **start**: light_off_s 3.25, self_sustain_s 10.9, idle_capture_s 14.3, T04_peak 1200, EGT_peak 1198, final_N_frac 0.4983, ok True
* **accel**: t_95pct_s 7.05, SM_min 0.1719, T04_peak 1200, Fn_final 523.6, SM_min_N_frac 0.8054, SM_min_band {'total': 0.08221083837632723, 'terms': {'rig (HECC/CC3 residuals, derived)': 0.0765416353793058, 'transient quasi-steady model form (declared)': 0.03}, 'dominant': 'rig (HECC/CC3 residuals, derived)', 'rule': 'RSS'}, ok True
* **decel**: t_to_idle_s 0.8, Wf_min 0.0007167, T04_min 487.7, ok True
* **hot_start**: T04_peak 1200, over_limit False
* **hung_start**: final_N_frac 0.1668, self_sustain_s -, hung True
* **igv_failed**: position open, igv_deg 0, SM_min 0.03416, SM_idle 0.1213, t_95pct_s 7.4, Fn_final 523.6, ok True
* **overspeed**: N_peak_frac 0.97, T04_peak 905.6, time_to_105pct_s -
* **flameout**: windmill_N_frac 0.02902, decay_to_light_off_s 7.4, relight_possible_at_M False, flight_mach 0
...
| OD-1 minimum surge margin along the running line | +0.069 | +/-0.077 (RSS) | rig 0.077 | -0.008 | 0.100 | FAIL | FAIL | L2 |
| OD-4 idle surge margin | +0.300 | +/-0.159 (RSS) | rig 0.077; igv extrapolation 0.140 (declared) | +0.141 | 0.080 | pass | pass | L2 |
| ENV-2 worst-case surge margin over the envelope | -0.046 | +/-0.077 (RSS) | rig 0.077 | -0.123 | 0.080 | FAIL | FAIL | L2 |
| TRN-4 minimum surge margin during the slam acceleration | +0.172 | +/-0.082 (RSS) | rig 0.077; transient quasi-steady model form 0.030 (declared) | +0.090 | 0.050 | pass | pass | L2 |
| TRN-10 surge margin with the IGV actuator failed (slam accel, vanes at the failure position) | +0.034 | +/-0.082 (RSS) | rig 0.077; transient quasi-steady model form 0.030 (declared) | -0.048 | 0.000 | pass | FAIL | L2 |

## Maps and plots

Schedules in force: bleed, nozzle, IGV; surge band +/-0.077 SM points (rig-calibrated, see docs/validation.md).  Interactive map: `analysis/plots/compressor_map.html`.
...
OD 183.3 mm x length 378.7 mm; estimated dry mass 6.66 kg.

| part | material | mass kg |
|---|---|---|
| impeller | Ti-6Al-4V | 0.854 |
| inlet_shroud | Al6061-T6 | 0.228 |
| igv_vanes | AISI321 | 0.061 |
| igv_ring | Al6061-T6 | 0.031 |
| igv_hub_bullet | Al6061-T6 | 0.013 |
| igv_actuator | servo + linkage | 0.060 |
...
* [L1] **CTL-1** bleed fraction at full opening: 0.15 vs 0.15  -> warn. larger bleeds cost too much low-speed thrust
* [L1] **CTL-2** variable nozzle area range A8_low / A8_design: 1.3 vs 1.35  -> warn. 
...
* [L2] **OD-1** minimum surge margin along the running line: 0.06865 vs 0.1  -> fail. lower the running line (larger nozzle), more backsweep, or a bleed / variable geometry
* [L2] **OD-2** max-thrust point recovers the design thrust: 0.9872 vs 0.95  -> warn. max thrust 494 N vs design 500 N (T04-limited)
* [L2] **ENV-1** fraction of envelope grid points cleared (converged, SM >= floor): 0.7083 vs 0.9  -> warn. see the envelope table for the failing corners
...
* [L2] **TRN-2** start light-off to self-sustain time: 7.65 vs 8 s -> warn. 
* [L2] **TRN-3** slam acceleration idle -> 95 % time: 7.05 vs 6 s -> warn. raise the accel limiter (watch SM)
...
|---|---|---|---|---|
| requirements | core | L0 | 2026-09-16T21:41:31 | - |
| cycle | core | L1 | 2026-09-16T21:41:31 | - |
| speed | core | L1 | 2026-09-16T21:41:31 | - |
| compressor | core | L1 | 2026-09-16T21:41:31 | - |
| turbine | core | L1 | 2026-09-16T21:41:31 | - |
| combustor | core | L1 | 2026-09-16T21:41:31 | - |
| layout | core | L0 | 2026-09-16T21:41:31 | - |
| rotor | core | L2 | 2026-09-16T21:41:31 | - |
| mechanical | core | L1 | 2026-09-17T00:34:00 | impeller.sigma_peak_Pa [L3], turbine.sigma_peak_Pa [L3], turbine.sigma_avg_Pa [L3] |
| control | core | L1 | 2026-09-16T21:41:31 | - |
| geometry | core | L0 | 2026-09-16T21:41:31 | - |
| maps | analysis | L2 | 2026-09-16T21:45:19 | - |
| offdesign | analysis | L2 | 2026-09-17T09:30:35 | - |
| assess | analysis | L2 | 2026-09-16T21:26:14 | - |
| throughflow | analysis | L2 | 2026-09-17T09:01:28 | - |
| combustor1d | analysis | L2 | 2026-09-17T09:31:22 | - |
| envelope | analysis | L2 | 2026-09-16T21:35:13 | - |
| transient | analysis | L2 | 2026-09-17T09:31:22 | - |
| thermal | analysis | L1 | 2026-09-17T09:30:35 | - |
| life | analysis | L1 | 2026-09-17T09:31:22 | sigma_bore_total_Pa [L3] |
| rotordyn | analysis | L2 | 2026-09-17T09:30:35 | - |
| manufacturing | analysis | L1 | 2026-09-17T09:30:35 | - |
| testbench | analysis | L2 | 2026-09-17T09:31:22 | - |
...
[layout]
  ...
  info LAY-2      engine length vs limit                            378.7 <= -          mm                [requirements.max_length_mm]
...
[geometry]
  info GEO-1      dry mass estimate vs limit                        6.660 <= -          kg                [requirements.max_mass_kg]
  info GEO-2      thrust/weight (info)                              7.653    -          -                 [-]
  info GEO-3      flange screws count (info)                       15.000    -                            [ISO 4762 M2]
[control]
  ok   CTL-8      IGV actuation rate required vs capability         9.375 <= 30.000     deg/s    +68.8 %  [schedule slope x fastest class acceleration (idle -> 95 % in 4 s)]
  ...
  WARN CTL-1      bleed fraction at full opening                    0.150 <= 0.150                +0.0 %  [handling bleeds 5-15 % (Saravanamuttoo)]
       -> larger bleeds cost too much low-speed thrust
  WARN CTL-2      variable nozzle area range A8_low / A8_design      1.300 <= 1.350                +3.7 %  [translating-plug / iris practice 1.0-1.3]
  ok   CTL-3      IGV pre-swirl range                              25.000 <= 40.000              +37.5 %  [IGV practice <= 30-40 deg]
...
[assess]
  ok   ASS-1      compressor quality score (mean of items)          0.850 >= 0.750               +13.3 %  [assessment items AQ-C*]
...
[combustor1d]
  ...
  ok   C1D-5      lean blow-out margin at idle                      1.332 >= 1.200               +11.0 %  [Lefebvre stability loop at the idle point]
...
[offdesign]
  FAIL OD-1       minimum surge margin along the running line       0.069 >= 0.100               -31.3 %  [SAE margin from the L2 map at N 1.05; band +/-0.077 = rig 0.077 (RSS) = 0.077]
       with band: +0.069 - 0.077 = -0.008 vs limit 0.100: fails with the band; dominant term: rig 0.077
  ...
  ok   OD-4       idle surge margin                                 0.300 >= 0.080              +275.1 %  [low-speed operability (boomsonic_v0 risk 4.2); band +/-0.159 = rig 0.077 + igv extrapolation 0.140 (RSS) = 0.159]
       with band: +0.300 - 0.159 = +0.141 vs limit 0.080: passes with the band; dominant term: igv extrapolation 0.140
[envelope]
  WARN ENV-1      fraction of envelope grid points cleared (converged, SM >= floor)      0.708 >= 0.900               -21.3 %  [SM floor 0.08; L2 maps]
...
[transient]
  ...
  WARN TRN-2      start light-off to self-sustain time              7.650 <= 8.000      s         +4.4 %  [micro-turbojet practice 3-8 s]
  WARN TRN-3      slam acceleration idle -> 95 % time               7.050 <= 6.000      s        -17.5 %  [class practice 3-6 s (JetCat ~4 s)]
       -> raise the accel limiter (watch SM)
  ok   TRN-4      minimum surge margin during the slam acceleration      0.172 >= 0.050              +243.8 %  [transient excursion toward surge at N 0.81; band +/-0.082 = rig 0.077 + transient quasi-steady model form 0.030 (RSS) = 0.082]
       with band: +0.172 - 0.082 = +0.090 vs limit 0.050: passes with the band; dominant term: rig 0.077
  ...
  ok   TRN-10     surge margin with the IGV actuator failed (slam accel, vanes at the failure position)      0.034 >= 0                    +3.4 %  [failed-open IGV at 0 deg; band +/-0.082 = rig 0.077 + transient quasi-steady model form 0.030 (RSS) = 0.082]
       with band: +0.034 - 0.082 = -0.048 vs limit 0.000: fails with the band (passes nominally); dominant term: rig 0.077
